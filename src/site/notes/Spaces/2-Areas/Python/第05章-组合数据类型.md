---
{"dg-publish":true,"dg-path":"Python/第05章-组合数据类型.md","permalink":"/Python/第05章-组合数据类型/"}
---

# 一、序列和索引
**序列**是一个用于存储多个值的连续空间，每个值都对应一个整数的编号，称为**索引**。在Python当中，序列的索引有正向递增和反向递减
![../../../Extras/Media/media-第05章-组合数据类型-1.png|5-1序列](/img/user/Extras/Media/media-%E7%AC%AC05%E7%AB%A0-%E7%BB%84%E5%90%88%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B-1.png)
属于序列结构的有字符串、列表、元组、集合和字典。其中字符串、列表和元组叫有序序列，集合和字典叫无序序列。同时，列表、元组、集合、字典又被称为Python当中的组合数据类型
## 1.序列的切片操作
**切片操作的语法结构：**
![../../../Extras/Media/media-第05章-组合数据类型-2.png|5-2切片操作的语法结构](/img/user/Extras/Media/media-%E7%AC%AC05%E7%AB%A0-%E7%BB%84%E5%90%88%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B-2.png)
通过切片操作后可以生成一个新的序列。
```python
s='HelloWorld'
# 切片操作
...
## 2.序列的相加和相乘操作
序列相加操作：
![../../../Extras/Media/media-第05章-组合数据类型-3.png|5-3序列相加操作](/img/user/Extras/Media/media-%E7%AC%AC05%E7%AB%A0-%E7%BB%84%E5%90%88%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B-3.png)
示例：
```python
s='Hello'
s2='World'
...
![../../../Extras/Media/media-第05章-组合数据类型-4.png|5-4列表对象的sort方法](/img/user/Extras/Media/media-%E7%AC%AC05%E7%AB%A0-%E7%BB%84%E5%90%88%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B-4.png)
举例：
```python
...
![../../../Extras/Media/media-第05章-组合数据类型-5.png|5-5内置函数sorted()](/img/user/Extras/Media/media-%E7%AC%AC05%E7%AB%A0-%E7%BB%84%E5%90%88%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B-5.png)
...
```
**二维列表:表格数据**
![../../../Extras/Media/media-第05章-组合数据类型-6.png|5-6二维列表](/img/user/Extras/Media/media-%E7%AC%AC05%E7%AB%A0-%E7%BB%84%E5%90%88%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B-6.png)
示例：
```python
# 创建二维列表
lst=[
...
![../../../Extras/Media/media-第05章-组合数据类型-7.png|5-7字典类型](/img/user/Extras/Media/media-%E7%AC%AC05%E7%AB%A0-%E7%BB%84%E5%90%88%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B-7.png)
## 1.字典的创建方式
字典创建方式有两种：
### （1）使用{}直接创建字典
第一种使用{}直接创建字典
...
zip(lst1,lst2)
```
![../../../Extras/Media/media-第05章-组合数据类型-8.png|5-8字典的创建方式：使用内置函数dict()创建字典](/img/user/Extras/Media/media-%E7%AC%AC05%E7%AB%A0-%E7%BB%84%E5%90%88%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B-8.png)
#### ②直接使用dict()去创建
**语法结构如下：**
```python
...
![../../../Extras/Media/media-第05章-组合数据类型-9.png|5-9集合类型的操作符](/img/user/Extras/Media/media-%E7%AC%AC05%E7%AB%A0-%E7%BB%84%E5%90%88%E6%95%B0%E6%8D%AE%E7%B1%BB%E5%9E%8B-9.png)
## 4.集合的相关操作方法
|集合的方法|描述说明|
|:-:|:-:|
